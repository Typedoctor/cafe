...
<body>
    <div class="sidebar">
        <ul>
            ...
            <li><a href="{{ route('add-to-shelf.index') }}"><i class="fa-solid fa-box"></i>Add to Shelf</a></li>
            <li><a href="{{ route('damaged-items.index') }}"><i class="fa-solid fa-box"></i>Damaged Items</a></li>
